...
{
    [CreateAssetMenu(fileName = "NewWeaponImpactProfile", menuName = "Scriptable Objects/Impact Feedback/Weapon Impact Profile")]
    public class WeaponImpactFeedbackProfile : ScriptableObject
    {
        [System.Serializable]
        public struct ImpactActionFeedbackEntry
        {
            ...
            public WeaponType impactActionType;
        ...
        public bool TryGetWeaponImpactActionFeedback(SurfaceType surface, WeaponType impactActionType, string tag,
